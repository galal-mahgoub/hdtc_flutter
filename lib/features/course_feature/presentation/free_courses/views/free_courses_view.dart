...
import '../controllers/free_courses_controller.dart';

class FreeCoursesView extends StatelessWidget {
  const FreeCoursesView({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<FreeCoursesController>(
      init: FreeCoursesController(
